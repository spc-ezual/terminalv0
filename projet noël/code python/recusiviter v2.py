...
##        haut,(bah gauche,bah droite,haut)
        creation_triangle(rep-1,new_co1),creation_triangle(rep-1,new_co2),creation_triangle(rep-1,new_co3)

def Sierpiński(taille,repetition,fond=(0,0,0),coul=(255,255,255)):
    a=time.time()
    sierp=Image.new("RGB",taille,font)
    ...
    sierp.save("triangle_{}_{}.jpg".format(taille,rep))
    b=time.time()
    print(b-a)
